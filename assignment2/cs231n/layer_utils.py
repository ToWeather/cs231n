...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that peforms the affine-BatchNorm-ReLU operation

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: the scale and shift for the batchnorm layer
    - bn_param: the parameters for the batchnorm layer
...
def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
    """
    Convenience layer that peforms the affine-LayerNorm-ReLU operation

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: the scale and shift for the layernorm layer
